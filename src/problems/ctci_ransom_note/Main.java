...
package problems.ctci_ransom_note;
...
public class Main {
    public static void main(String[] args) {
        String path = "/media/ritam/Storage/Projects/IdeaProjects/Playground/Hacker Rank/src/problems.ctci_ransom_note/testcase.txt";
