...
package problems.climbing_the_leaderboard;
...
public class Main {
	...
	public static void main(String[] args) {
		String path = "/media/ritam/Storage/Projects/IdeaProjects/Playground/Hacker Rank/src/problems.climbing_the_leaderboard/testcase.txt";
