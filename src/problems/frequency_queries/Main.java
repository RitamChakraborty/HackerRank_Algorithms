...
package problems.frequency_queries;
...
public class Main {
	...
	public static void main(String[] args) {
		String path = "/media/ritam/Storage/Projects/IdeaProjects/Playground/Hacker Rank/src/problems.frequency_queries/testcase.txt";
