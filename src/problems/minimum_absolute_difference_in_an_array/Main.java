...
package problems.minimum_absolute_difference_in_an_array;
...
public class Main {
    ...
    public static void main(String[] args) {
        String path = "/media/ritam/Storage/Projects/IdeaProjects/Playground/Hacker Rank/src/problems.minimum_absolute_difference_in_an_array/testcase.txt";
