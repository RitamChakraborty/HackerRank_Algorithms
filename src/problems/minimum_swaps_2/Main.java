package problems.minimum_swaps_2;
...
public class Main {
    ...
    public static void main(String[] args) {
        String path = "/media/ritam/Storage/Projects/IdeaProjects/Playground/Hacker Rank/src/problems.minimum_swaps_2/testcase.txt";
