...
package problems.repeated_string;
...
public class Main {
    ...
    public static void main(String[] args) {
        String path = "/media/ritam/Storage/Projects/IdeaProjects/Playground/Hacker Rank/src/problems.repeated_string/testcase.txt";
